    ...
    $.fn.coinslider = $.fn.CoinSlider = function(options) {
        var setFields = function(el) {
            var tWidth = parseInt(params[el.id].width / params[el.id].spw),
                ...
                sLeft = 0,
                sTop = 0,
                i, j, tgapx = params[el.id].width - params[el.id].spw * sWidth,
                gapx = tgapx,
        ...
        var transition = function(el, direction) {
            ...
            if (titles[el.id][imagePos[el.id]]) {
                ...
                $('#cs-title-' + el.id).animate({
                    opacity: 0
                }, 200);
                $('#cs-title-' + el.id).html('<a href="'+titles[el.id][imagePos[el.id]]+'">Podrobnee</a>');
                 setTimeout(function(){
                     $('#cs-title-' + el.id).animate({
                        opacity: 1
                     }, 200)                
        ...
        var setNavigation = function(el) {
            if (params[el.id].showNavigationPrevNext) {
                ...
                $('#cs-navigation-' + el.id + ' a').mouseout(function() {
                    if (!params[el.id].navigationPrevNextAlwaysShown) $('#cs-navigation-' + el.id).hide();
                    params[el.id].pause = false
                })
            }
